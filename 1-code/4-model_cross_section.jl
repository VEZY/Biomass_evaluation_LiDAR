...
md"""
*Figure 1. Measured (x-axis) and predicted (y-axis) cross-section at axis scale. The prediction is done either using the topological model (Topo. mod.), or the pipe model (Pipe mod.).*
"""
