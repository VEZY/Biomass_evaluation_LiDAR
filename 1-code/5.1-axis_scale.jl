...
md"""
# Step 4: branches volume and biomass prediction (axis scale)
...
md"""
*Figure 1. Measured (x-axis) and predicted (y-axis) length at axis scale. n = $(nrow(filter(row -> row.Model == "SM", dropmissing(df_compare, [:length, :length_meas]))))*
"""
...
manifest_format = "2.0"
project_hash = "bead04d853649b4f9966dde999208d0ad48cd81a"
